...
# ============================================================================
# КОНСТАНТЫ ДЛЯ TOP-3 НАПРАВЛЕНИЙ
# ============================================================================

# идентификатор потока
FLOW_TOP3 = "top3_flow"

# --- состояния (берём диапазон 100-103, чтобы не пересекаться с остальными) ---
(
    TOP3_ASK_SCOPE,       # 100 – «отовсюду или из города?»
    TOP3_ASK_COUNTRY,     # 101 – выбор страны
    TOP3_ASK_CITY,        # 102 – выбор города
    TOP3_ASK_SAVE,        # 103 – сохранить настройки?
) = range(100, 104)

# --- callback-data ---
CALLBACK_START_TOP3       = "start_top3"
CALLBACK_TOP3_SPECIFIC_CITY = "top3_specific_city"
CALLBACK_TOP3_FROM_ANYWHERE = "top3_from_anywhere"
CALLBACK_TOP3_SAVE_YES      = "top3_save_yes"
CALLBACK_TOP3_SAVE_NO       = "top3_save_no"

# --- сообщения ---
MSG_TOP3_WELCOME = "🔥 Топ-3 самых дешёвых направления"
MSG_TOP3_SCOPE   = "🌍 Ищем отовсюду или выберете конкретный город?"
MSG_TOP3_SAVED   = "👍 Настройки Top-3 сохранены!"
MSG_TOP3_NOT_SAVED = "👌 Настройки Top-3 не сохранены."

# ---------------------------------------------------------------------------
# Популярные аэропорты Ryanair/лоукостеров для поиска «отовсюду»
# ---------------------------------------------------------------------------
